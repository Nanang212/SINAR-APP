  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div class="col-span-1 md:col-span-2">
        <h3 class="text-lg font-bold text-gray-900 mb-4">Sinar App</h3>
        <p class="text-gray-600 mb-4">Making the world a better place through constructing elegant hierarchies.</p>
      ...
      <div>
        ...
        <ul class="space-y-3 text-sm text-gray-600">
          ...
          <li><a href="#" class="hover:text-gray-900">Commerce</a></li>
    ...
    <div class="mt-8 pt-8 border-t border-gray-200">
      <p class="text-center text-sm text-gray-600">
        &copy; 2025 Sinar App. All rights reserved.
      </p>
    </div>
  </div>
</footer>